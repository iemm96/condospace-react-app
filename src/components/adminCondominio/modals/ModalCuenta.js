...
const ModalCuenta = (props) => {
    ...
    useEffect(() => {
        ...
        async function getRecord() {
            try {
                const resultadoRecord = await fetchRecord(props.idRecord,'cuentas',idCondominio);
    ...
    const onSubmit = async (data) => {
        ...
        if(record) {
            ...
            try {
                ...
                const response = await updateRecord(data,'cuentas',record.idCuenta,idCondominio);
    ...
    return(<Modal isOpen={props.recordModal} toggle={() => props.toggleModal()}>
        <ModalHeader toggle={() => props.toggleModal()}>{props.idRecord ? 'Actualizar' : 'Crear'} Cuenta</ModalHeader>
        <ModalBody>
